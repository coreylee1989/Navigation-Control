...
class FacultyTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let facultyMember = faculty[indexPath.row]
        
        cell.textLabel?.text = facultyMember.firstName + " " + facultyMember.lastName
        cell.detailTextLabel?.text = facultyMember.title + ", " + facultyMember.degree
        
        cell.imageView?.image = UIImage(named: facultyMember.userName.lowercased() + ".jpg")

        return cell
    }
    
    func processFacultyJSON() {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = self.tableView.indexPathForSelectedRow {
            dest.facultyMember = faculty[indexPath.row]
        }
    }
